...
try {
    ...
    // Busca os últimos 5 grupos ativos
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body table-responsive">
                        <?php if (empty($latest_groups)): ?>
                            <p class="text-muted text-center mb-0">Nenhum grupo ativo encontrado.</p>
                        <?php else: ?>
