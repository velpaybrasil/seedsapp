-- Atualiza a tabela de Grupos de Crescimento
ALTER TABLE growth_groups
ADD COLUMN description TEXT NULL AFTER name,
ADD COLUMN meeting_time TIME NULL AFTER meeting_day,
ADD COLUMN meeting_address VARCHAR(255) NULL AFTER meeting_time,
...
-- Tabela de Participantes do Grupo (se não existir)
...
-- Tabela de Reuniões do Grupo (se não existir)
...
-- Tabela de Presença nas Reuniões (se não existir)
