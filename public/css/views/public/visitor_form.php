...
$styles = '<link href="/gcmanager/assets/css/public.css" rel="stylesheet">';
?>
        ...
        <div class="col-md-8">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <form action="/gcmanager/public/visitor/store" method="POST" class="needs-validation" novalidate>
                        <!-- Dados Pessoais -->
