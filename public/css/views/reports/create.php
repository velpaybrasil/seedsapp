...
<div class="container-fluid px-4">
    <h1 class="mt-4">Novo Relatório</h1>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="/gcmanager/reports/store" method="POST">
                <?= csrf_field() ?>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="type" name="type" required>
                            ...
                            <option value="visitors" <?= old('type') === 'visitors' ? 'selected' : '' ?>>Visitantes</option>
                            <option value="groups" <?= old('type') === 'groups' ? 'selected' : '' ?>>Grupos</option>
                            <option value="volunteers" <?= old('type') === 'volunteers' ? 'selected' : '' ?>>Voluntários</option>
                        </select>
                    </div>
                </div>
