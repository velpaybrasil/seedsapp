    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="/gcmanager/settings/update-password" method="POST">
                        <div class="mb-3">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="/gcmanager/settings/update-email" method="POST">
                        <div class="mb-3">
...
async function terminateAllSessions() {
    ...
    try {
        const response = await fetch('/gcmanager/settings/terminate-all-sessions', {
            method: 'POST'
        });
