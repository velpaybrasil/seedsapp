<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div>
            <a href="/gcmanager/volunteers/schedule" class="btn btn-primary me-2">
                <i class="bi bi-calendar-plus"></i> Nova Escala
            </a>
            <a href="/gcmanager/volunteers/create" class="btn btn-success">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="/gcmanager/volunteers">Todos</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="/gcmanager/volunteers?ministry=música">Música</a></li>
                            <li><a class="dropdown-item" href="/gcmanager/volunteers?ministry=mídia">Mídia</a></li>
                            <li><a class="dropdown-item" href="/gcmanager/volunteers?ministry=recepção">Recepção</a></li>
                            <li><a class="dropdown-item" href="/gcmanager/volunteers?ministry=infantil">Infantil</a></li>
                        </ul>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-hover" id="volunteersTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="/gcmanager/volunteers/edit/<?= $volunteer['id'] ?>" 
...
async function toggleVolunteerStatus(volunteerId) {
    ...
    try {
        showLoading();
        const response = await fetch(`/gcmanager/volunteers/${volunteerId}/toggle-status`, {
            method: 'POST'
        });
...
$('#scheduleModal').on('show.bs.modal', async function(event) {
    ...
    try {
        const response = await fetch(`/gcmanager/volunteers/${volunteerId}/schedules`);
...
async function updateScheduleStatus(scheduleId, status) {
    try {
        showLoading();
        const response = await fetch(`/gcmanager/volunteers/schedules/${scheduleId}`, {
            method: 'POST',
            headers: {
